...
#    Updated: 2025/02/11 13:19:15 by pamatya          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
D_SRC		=	src
D_TEST		=	src_test
D_PTHREADS	=	$(D_TEST)/src_test_pthreads
...
SRC_MAIN	=	test_main.c routines.c \
				test_first_threads.c test_mutex.c test_mutex_loop.c \
				test_thread_return.c test_print_primes.c test_sum_primes.c \
				test_trylock.c

# VPATH		+=	$(D_PTHREADS) $(D_SRC)
VPATH		+=	$(D_SRC) $(D_PTHREADS)
